...
@tool
def find_celebrity_image(query: str) -> list[str]:
    """
    Find top 3 celebrity images using google image search and returns a 
    list of local file paths to the downloaded images.

    Args:
        query: A descriptive search query for the celebrity image
    """
