...
class BBox(BaseModel):
    ...
    page: int = Field(description="The page number of the bounding box")
    ymin: float = Field(description="The y coordinate of the top of the bounding box")
    xmin: float = Field(description="The x coordinate of the left of the bounding box")
    ymax: float = Field(description="The y coordinate of the bottom of the bounding box")
    xmax: float = Field(description="The x coordinate of the right of the bounding box")
