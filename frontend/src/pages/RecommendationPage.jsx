      ...
      <main style={{ flexGrow: 1, padding: '32px 20px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: colors.text.secondary, marginBottom: '24px' }}>
            ...
            <ChevronRight size={12} />
            <span style={{ color: colors.text.primary, fontWeight: '500' }}>Recommendations</span>
          </div>
            ...
            <div style={{ gridColumn: 'span 9' }} className="col-span-12 lg:col-span-9">
              ...
              <div style={{
                ...
                <h1 style={{ 
                  ...
                  We're making a few alterations.
                </h1>
                ...
                <p style={{ 
                  ...
                  Our Shopping Assistants are currently getting the measure of your style. We're making final adjustments to ensure your recommendations are a perfect fit.
                </p>
