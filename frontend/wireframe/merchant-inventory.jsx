...
export default function Dashboard() {
  ...
  const filteredInventory = useMemo(() => {
    ...
    // Tag filter - match ANY of the selected tags
    ...
    <div style={{
      ...
      <main style={{ padding: '24px 32px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            <h1 style={{ fontSize: '28px', fontWeight: '700', color: '#1a202c', margin: '0 0 4px' }}>
              Inventory
            </h1>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', flex: '1', minWidth: '250px', maxWidth: '400px' }}>
            <svg
              style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', color: '#a0aec0' }}
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              ...
              <svg 
                width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="2"
                style={{ 
                  position: 'absolute', 
                  right: '10px',
              ...
              <>
                ...
                <div style={{
                  ...
                  <div style={{ padding: '12px', borderBottom: '1px solid #e2e8f0' }}>
                    <div style={{ position: 'relative' }}>
                      <svg
                        style={{ position: 'absolute', left: '10px', top: '50%', transform: 'translateY(-50%)', color: '#a0aec0' }}
                      ...
                      .map(tag => {
                        ...
                        return (
                          <div
                            ...
                            onMouseLeave={(e) => {
                              e.currentTarget.style.background = isSelected ? '#ebf8ff' : 'white';
                            }}
                          >
                            <div style={{
                              width: '18px',
                              ...
                              background: isSelected ? '#4299e1' : 'white',
                              display: 'flex',
                              alignItems: 'center',
                              justifyContent: 'center',
                              flexShrink: 0
                            ...
                            <span style={{
                              ...
                              {inventory.filter(item => item.tags.includes(tag)).length}
                            </span>
                          </div>
                        );
                      })}
        ...
        {selectedItems.size > 0 && (
          <div style={{
            ...
            <span style={{ fontSize: '14px', color: '#2b6cb0', fontWeight: '500' }}>
              ...
              {paginatedInventory.length === 0 ? (
                  ...
                  <td colSpan="6" style={{ padding: '60px 16px', textAlign: 'center' }}>
                    <div style={{ color: '#a0aec0' }}>
                      ...
                      <p style={{ margin: 0, fontSize: '14px' }}>
                        {searchQuery || selectedTags.length > 0 ? 'Try adjusting your filters' : 'Import products to get started'}
                      </p>
                    </div>
                  </td>
                </tr>
                ...
                paginatedInventory.map((item, index) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{
                          ...
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a0aec0" strokeWidth="1.5">
                    ...
                    <td style={{ padding: '14px 16px', fontFamily: 'monospace', fontSize: '13px', color: '#718096' }}>
                      {item.sku}
                    </td>
                    <td style={{ padding: '14px 16px', textAlign: 'right', fontWeight: '500', color: '#1a202c' }}>
                      ${item.price.toFixed(2)}
                    </td>
                    <td style={{ padding: '14px 16px', textAlign: 'right' }}>
                      <span style={{
                        color: item.quantity < 20 ? '#c53030' : item.quantity < 50 ? '#d69e2e' : '#38a169',
                        fontWeight: '500'
                      }}>
                        {item.quantity}
                      </span>
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: '14px',
                      border: '1px solid',
                      borderColor: page === currentPage ? '#4299e1' : '#e2e8f0',
                      borderRadius: '6px',
                      background: page === currentPage ? '#4299e1' : 'white',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 8px', fontSize: '14px', color: '#4a5568' }}>
                You are about to delete {selectedItems.size} item{selectedItems.size > 1 ? 's' : ''}:
              </p>
              <ul style={{ margin: 0, paddingLeft: '20px' }}>
                {inventory.filter(item => selectedItems.has(item.id)).map(item => (
                  <li key={item.id} style={{ fontSize: '14px', color: '#718096', marginBottom: '4px' }}>
                    {item.name} ({item.sku})
                  </li>
                ))}
              </ul>
      ...
      {showBulkImport && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 8px', fontSize: '20px', fontWeight: '600' }}>Bulk Import</h3>
            <p style={{ margin: '0 0 24px', fontSize: '14px', color: '#718096' }}>
              This feature will be designed in the next wireframe
            </p>
            <button
